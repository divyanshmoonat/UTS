...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("appstatestaticsignup",""+ UTSDto.sessionId+"may be null");
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                if(check.equals("true")){
                    ...
                    url = SignupActivity.this.getString(R.string.new_user_registration);
                    URL urlThrow = new URL(url);
                    HttpURLConnection connection = (HttpURLConnection) urlThrow.openConnection();
                    ...
                    signupData.put("phone",mobileNumber);
