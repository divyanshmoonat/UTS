...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userName.equals("")&&password.equals("")){
            ...
            UTSDto.userName = userName;
            UTSDto.password = password;
...
//                reg.setPassword(password);
    ...
    public class ValidateLogin extends AsyncTask<Void,String,String>{
        ...
        protected String doInBackground(Void...voids) {
            ...
            try {
                loginData.put("email",UTSDto.userName);//LOADING DATA TO JSON FILE.
                loginData.put("pass",UTSDto.password);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                UTSDto.sessionId = sessionId;
                Log.i("appstatestatic",""+UTSDto.sessionId);
            } catch (JSONException e) {
                e.printStackTrace();
            ...
            if (sessionId.equals("false")){
               ...
               // reg.setSessionId(sessionId);
                ...
                if (remember.isChecked()){
                    editor.putString("userName",UTSDto.userName);//AT SOME PLACES USERNAME AND EMAIL ARE SAME.
                    editor.putString("password",UTSDto.password);
                    editor.putString("sessionId",UTSDto.sessionId);
                    editor.commit();
                }
...
//                intent.putExtra("sessionId",""+reg.getSessionId());
                ...
                Log.i("APPSTATE SENDING",""+UTSDto.sessionId);
