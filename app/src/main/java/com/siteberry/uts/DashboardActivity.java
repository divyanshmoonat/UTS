...
//        mosh = new MyOpenSQLiteHelper(this,"uts",null,1);
//        userDao = new User(mosh);
//        SQLiteDatabase db = mosh.getReadableDatabase();
//        Cursor c = db.query("user",
//                new String[]{"userName","password"}, null, null, null, null, null);
//        while (c.moveToNext()){
//            reg.setUserName(c.getString(0));
//            reg.setPassword(c.getString(1));
//        }
//        Log.i("appstate",""+reg.getUserName());
...
//            String sessionId = sp.getString("sessionId","");//SESSION ID OF THE LOGGED IN USER
            String urlParams = strings[0];
